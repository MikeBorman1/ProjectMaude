...
const httpTrigger = function (context, req) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const report = yield pool.request()
            .input("ReportId", reportId)
            .execute("getReport");
        context.res.end(JSON.stringify({
            reportId: report.recordset[0].ReportId,
            reportTitle: report.recordset[0].ReportTitle,
            barcode: report.recordset[0].Barcode,
            reportImageUrl: report.recordset[0].ReportImageUrl
        }));
    });
};
