...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "CPMA-Core-APP.Android.dll" comes first in this list. */
		"CPMA-Core-APP.Android.dll",
		"CPMA-Core-APP.dll",
		...
		"zxing.portable.dll",
		"ZXingNetMobile.dll",
		"CPMA-Core-APP.Common.dll",
		"CPMA-Core-APP.API.dll",
		"CPMA-Core-APP.Utils.dll",
		"CPMA-Core-APP.Model.dll",
		"CPMA-Core-APP.ViewModels.dll",
	};
